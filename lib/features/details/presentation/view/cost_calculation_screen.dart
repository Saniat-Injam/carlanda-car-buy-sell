...
//   CostCalculationScreen({super.key});
//   static const String routeName = '/details/cost-calculation';
//   final DetailsController detailsController = Get.find<DetailsController>();
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: CustomAppbar(title: "Cost Calculation"),
//       body: Padding(
...
//                 //   onTap: (value) => controller.selectPaymentOption(
...
class CostCalculationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppbar(title: "Cost Calculation"),
      body: Padding(
        padding: EdgeInsets.fromLTRB(28, 0, 23, 0),
